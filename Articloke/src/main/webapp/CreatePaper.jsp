                ...
                <div class ="position-relative d-inline-block starci-horizontal-center mt-3">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu position-absolute p-3">
                              ...
                              <button class ="btn btn-lg starci-button-sp starci-background position-relative starci-no-break" name = "action" value = "Standard"> <span class = "h5"> Standard (Free)</span></button> 
                              <button class ="mt-3 btn btn-lg starci-button-sp starci-background position-relative starci-no-break" name = "action" value = "Advanced"> <span class = "h5"> Advanced (49$/Submission)</span></button> 
