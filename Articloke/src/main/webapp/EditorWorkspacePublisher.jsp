            ...
            <div class ="row m-0 p-0">
                <div class ="col-4 p-3">
                    ...
                    <section class = "py-4">
                        ...
                        <button type = "submit" class = "btn btn-white starci-button-sp" style = "width: 100%">
                            <span class = "h5"> Reviewer Workspace </span>
                        </button>
                ...
                <div class ="col-8 p-4">         
                    ...
                    <section class = "p-4">
                        ...
                        <div style = "overflow: auto; min-height: 420px" class ="starci-hide-scrollbar position-relative p-0">
                            <c:forEach items = "${applicationScope.approvedPapers}" var = "paper"> 
