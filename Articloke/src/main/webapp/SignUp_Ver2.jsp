...
<html>
    ...
    <body>
        <!-- Div Surround -->
        <div class = "container-fluid position-absolute p-0" style = "min-height: 140%">
            <jsp:include page="Navigation.jsp" /> 
            <!-- Section 1 -->
            <div class ="position-absolute pb-3 custom-center " style ="border: 1px solid;  width: 100%; max-width: 400px; top: 45%">
