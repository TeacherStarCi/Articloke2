...
<html>
    ...
    <body>
        <div class ="container-fluid p-0 position-relative">
            ...
            <div class ="container-fluid p-0 position-relative pb-4 pt-1" style = "border-bottom: 2px solid;">  
                ...
                <div class = "container p-0">
                    ...
                    <div class ="d-flex">
                        ...
                        <button class ="btn btn-light  mx-3 mt-1 position-relative border-dark" data-toggle="collapse" data-target="#j1">Advance Search</button>   
                            ...
                            <div class ="col-3">
                                <div class="input-group position-relative" >
                                    ...
                                    <select form ="ShowArticleResultServlet" name = "sortedBy" type="text" class="form-control" placeholder="Permission" aria-label="Permission" aria-describedby="5">
                                        ...
                                        <option value = "Published Date"> Published Date (Oldest - Latest)</option>
            ...
            <div class =" container p-0 position-relative mt-5 ">
                ...
                <span class = "h5"> All Results </span>
                ...
                <c:if test = "${empty requestScope.articles && requestScope.searchEmpty}">
                    ...
                    <c:if test = "${!requestScope.searchEmpty}">
                        ...
                        <img src ="Image/Fancy.png" class ="mt-3 position-relative img-fluid">
