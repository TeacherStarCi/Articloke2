                    ...
                    <div class = "row mt-5">
                        <div class ="col-6">
                            ...
                            <div style = "font-size: 20px" > 
                                ...
                                <span class ="h4"> Artichoke Pendals: ${requestScope.totalCount}  <img src ="Image/HeartIcon.png" class ="d-inline-block position-relative mt-2" style ="width: 30px;top:-7px"> 
                                </span>
                            </div>  
                        </div>
                        <div class ="col-6">
