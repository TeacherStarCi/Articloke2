        ...
        <body>
          ...
          <div class="container-fluid p-0 position-absolute" style="min-height: 130%">
            ...
            <div class="container p-0 position-relative" style="height: 160px; border-bottom: 2px solid">
              ...
              <img src="${sessionScope.user.picture}" style="width: 120px; height: 120px; top: 100px;" class="custom-horizontal-center position-absolute rounded-circle"></div>
                        ...
                        <div class="col-6">
                          ...
                          <br>
                            <div style="font-size: 20px">
                              Date Of Birth: ${sessionScope.user.DOB}
                              <br>
                                ...
                                <br>
                                  ...
                                  <br>
                                    ...
                                    <br>
                                      Organization: ${sessionScope.user.organization}
                                      <br>
                                        Phone Number: ${sessionScope.user.organization}
                                        <br>
                                          <div class="custom-horizontal-line"></div>
                                          <span class="h4">
                                            Artichoke Pendals: ${requestScope.totalCount}
                                            <img src="Image/HeartIcon.png" class="d-inline-block position-relative mt-2" style="width: 30px;top:-7px"></span>
                                          </div>
                                        </div>
                                        <div class="col-6">
                                          ...
                                          <br>
                                            <div class="container p-0" style="border: 2px solid">
                                              <div class="container-fluid p-0 custom-hover-topic" style="height: 60px">
                                                <span class="d-inline-block h4 position-relative custom-center ">
                                                  Edit Information &nbsp;
                                                  <img src="Image/EditInf.png" style="width: 36px;"></span>

                                                </div>
                                                <div class="container-fluid p-0 custom-hover-topic" style="height: 60px">
                                                  <span class="d-inline-block h4 position-relative custom-center ">
                                                    Change Password &nbsp;
                                                    <img src="Image/ChangePassword.png" style="width: 36px;"></span>

                                                  </div>
                                                  <div class="container-fluid p-0 custom-hover-topic" style="height: 60px">
                                                    <span class="d-inline-block h4 position-relative custom-center ">
                                                      Authenticate Email &nbsp;
                                                      <img src="Image/EmailS.png" style="width: 36px;"></span>
                                            ...
                                            <div class="container px-0 pt-5 position-relative">
                                              ...
                                              <div class=" row mt-3">
                                                <div class="col-6">
                                                  <span class="position-relative d-inline-block h4" style="color:#C6B6C5">
                                                    My Papers
                                                  </span>
                                                  ...
                                                  <c:if test="${empty requestScope.papers}">
                                                    <br>
                                                      <span class="h4">
                                                        You have not created any paper.
                                                      </span>
                                                            ...
                                                            <div class="col-8">
                                                              ...
                                                              <br>
                                                                ...
                                                                <br>
                                                                  ...
                                                                  <div class="col-4">
                                                                    <button type="text" class="btn btn-light border-dark position-relative custom-center">
                                                                      Edit</button>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                            </c:forEach>
                                                            <span class="position-relative d-inline-block mt-3">
                                                              Show more Papers
                                                            </span>
                                                          </c:if>
