            ...
            <div class ="row m-0 p-0">
                <div class ="col-4 p-4">
                    ...
                    <section class = "p-4 starci-rounded shadow" style = "background: #D2C4B8">
                        ...
                        <form id = "SearchEditWorkspaceServlet" action="SearchEditWorkspaceServlet"> </form>
                        <div class ="d-flex">
                            <div class="form-floating flex-fill me-3">
                                <input form ="SearchEditWorkspaceServlet" type="text" class="form-control" name = "keyword" value = "${requestScope.keyword}" id="floatingInput" placeholder="name@example.com"   >
                                <label for="floatingInput" > Keyword </label>
                            </div>

                            <button form ="SearchEditWorkspaceServlet" type = "submit" class = " btn btn-white starci-button-sp2 float-end position-relative">
                        ...
                        <div class ="d-flex mt-3"> 
                            <div class ="flex-fill">
                                <div class="form-floating me-3">
                                    <select form ="SearchEditWorkspaceServlet" class="form-select" id="sel1" name ="display">
                                ...
                                <div class ="flex-fill"> 
                                    <div class="form-floating ">
                                        ...
                                        <select form ="SearchEditWorkspaceServlet" class="form-select" id="sel1" name="topic">
                        ...
                        <div class = "d-flex mt-3" style = "margin-left: 0.75rem"> 
                            ...
                            <input style = "width: 2rem; height: 2rem" form ="SearchEditWorkspaceServlet" name ="advanced" class = "vertical-center mr-3" type = "checkbox" value = "checked" <c:if test = "${requestScope.advanced}"> checked </c:if>>
                        </div>     
